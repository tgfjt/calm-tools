const tokens = {
  ...
  "colors.breath.bg": {
    "value": "#1a3d0a",
    "variable": "var(--colors-breath-bg)"
  },
  "colors.breath.text": {
    "value": "#e8f5e9",
    "variable": "var(--colors-breath-text)"
  },
  "colors.breath.accent": {
    "value": "#8bc34a",
    "variable": "var(--colors-breath-accent)"
  },
  "colors.breath.muted": {
    "value": "#c5e1a5",
    "variable": "var(--colors-breath-muted)"
  },
  "colors.breath.accentLight": {
    "value": "#aed581",
    "variable": "var(--colors-breath-accent-light)"
  },
  "colors.breath.border": {
    "value": "rgba(165, 214, 167, 0.3)",
    "variable": "var(--colors-breath-border)"
  },
  "colors.grounding.bg": {
    "value": "#fef9f3",
    "variable": "var(--colors-grounding-bg)"
  },
  "colors.grounding.text": {
    "value": "#5a5a5a",
    "variable": "var(--colors-grounding-text)"
  },
  "colors.grounding.textLight": {
    "value": "#8a8a8a",
    "variable": "var(--colors-grounding-text-light)"
  },
  "colors.grounding.pink": {
    "value": "#ffd6e0",
    "variable": "var(--colors-grounding-pink)"
  },
  "colors.grounding.blue": {
    "value": "#d4e4f7",
    "variable": "var(--colors-grounding-blue)"
  },
  "colors.grounding.purple": {
    "value": "#e8d9f5",
    "variable": "var(--colors-grounding-purple)"
  },
  "colors.home.primary": {
    "value": "#667eea",
    "variable": "var(--colors-home-primary)"
  },
  "colors.home.secondary": {
    "value": "#764ba2",
    "variable": "var(--colors-home-secondary)"
  },
  "gradients.home": {
    "value": "linear-gradient(135deg, #667eea 0%, #764ba2 100%)",
    "variable": "var(--gradients-home)"
  },
  "gradients.breath": {
    "value": "linear-gradient(135deg, #2d5016 0%, #1a3d0a 50%, #0f2805 100%)",
    "variable": "var(--gradients-breath)"
  },
  "gradients.grounding": {
    "value": "linear-gradient(135deg, #d4e4f7 0%, #ffd6e0 50%, #e8d9f5 100%)",
    "variable": "var(--gradients-grounding)"
  },
  "fonts.sans": {
  ...
  "colors.colorPalette.accentLight": {
    "value": "var(--colors-color-palette-accent-light)",
    "variable": "var(--colors-color-palette-accent-light)"
  },
